...
int main(int argc, char** argv){
    ...
    unsigned char import[0x200] = {
        0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x38, 0x00, 0x00, 0x00,
        ...
        0x43, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 'm' , 's' , 'v' , 'c' , 'r' , 't' , '.' , 'd' ,
    ...
    *(int*)&buf->_buf[addrputc] = hdr.OptionalHeader.ImageBase + sections[1].VirtualAddress + 0x28;
    ...
    (*(IMAGE_IMPORT_DESCRIPTOR*)&import[0]).OriginalFirstThunk += sections[1].VirtualAddress;
    (*(IMAGE_IMPORT_DESCRIPTOR*)&import[0]).Name += sections[1].VirtualAddress;
    (*(IMAGE_IMPORT_DESCRIPTOR*)&import[0]).FirstThunk += sections[1].VirtualAddress;

    (*(IMAGE_THUNK_DATA32*)&import[0x28]).u1.AddressOfData += sections[1].VirtualAddress;
    (*(IMAGE_THUNK_DATA32*)&import[0x30]).u1.AddressOfData += sections[1].VirtualAddress;
